...
<div class="flex flex-col bg-dark-color-lighter px-2 rounded-lg shadow-lg w-80 md:w-52 lg:w-80 xl:w-96">
    <p class="text-lg font-light text-accent-2-color-lighter p-0 py-1 m-0">{name}</p>
    {#await promise}
        <h2>please wait..</h2>
    {:then data}
